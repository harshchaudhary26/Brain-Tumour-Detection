...
def page_layout():
    ...
    st.write("- BrainVision combines multiple ML models into one app")
    ...
    st.markdown("## Uses:")
    st.write("- Hospitals and clinics can use BrainVision to diagnose diseases more quickly")
    st.write("- Patients can use BrainVision to get a quick and accurate diagnosis without the need for invasive procedures")
